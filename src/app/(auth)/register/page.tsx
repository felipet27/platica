      ...
      >
        ...
        <div>
          <h1 className="text-4xl font-bold leading-snug mb-4">
            Es hora de organizar<br />
            <span className="text-green-200">las cuentas.</span>
          </h1>
          <p className="text-green-100 text-lg mb-10">
            Empieza gratis y descubre a dónde se va cada peso.
          </p>
          <ul className="space-y-4">
            {[
              "Registra compromisos fijos y variables",
              "Visualiza tu balance mes a mes",
              "Recibe consejos hechos a tu medida",
            ].map((texto) => (
        ...
        <div className="flex flex-col justify-center flex-1 px-8 sm:px-12 lg:px-16 py-10">
          <div className="max-w-md w-full mx-auto">
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-500 text-sm mt-1">Gratis · Sin tarjeta · Sin límites</p>
            </div>
