    ...
    <div className="space-y-6 max-w-2xl">
      <div>
        <div className="flex items-center gap-2">
          ...
          <PageInfoTooltip text="Personaliza la forma en que Platíca muestra tu información. Por ahora puedes elegir la moneda en que se expresan tus cifras (COP, USD, EUR, MXN, BRL). La preferencia se guarda en tu cuenta y aplica en todo El resumen." />
        </div>
